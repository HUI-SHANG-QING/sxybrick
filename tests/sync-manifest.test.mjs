...
test('清单：22 张表全部登记且策略合法', () => {
  // v19 新增 dailyPlans + dailyTasks → 20；v22（M1）新增 cardGroups + cardGroupLinks → 22
  assert.equal(SYNC_TABLES.length, 22);
  ...
  for (const need of ['cards', 'reviews', 'images', 'aiChats', 'aiMemories', 'memos', 'plans', 'graphEdges', 'docs', 'docFiles', 'pomoSessions', 'mindmaps', 'weeklyReports', 'achievements', 'exams', 'embeddings', 'userOps', 'notes', 'dailyPlans', 'dailyTasks', 'cardGroups', 'cardGroupLinks']) {

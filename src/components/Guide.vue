...
const steps = [
  ...
  { title: '背诵复习', text: '「背诵」页按记忆曲线自动安排到期卡片，自评「没记住/还模糊/记住了」后自动算好下次时间。' },
  { title: 'AI 学习助手', text: '「AI助手」能结合你的真实数据答疑、智能组卡、费曼学习法、生成周报、诊断卡片。' },
  { title: 'Agent 工作台', text: '「Agent工作台」内置 10 个专业 Agent（答疑/分析/组卡/出题/计划/口诀/错题/图谱/智能复习等），支持自动路由、多步工具编排与轨迹可视化，工具可运行时扩展。' },
  { title: '学习工具箱', text: '费曼学习法（以教代学）、错题集、番茄钟、四象限备忘录，帮你科学安排复习节奏。' },
  ...
  { title: '多端同步', text: '「同步」页提供两种本地同步：① 导出/导入数据包；② 同一局域网手机/平板/电脑一键同步。所有模块数据（卡片/记录/费曼/AI/Agent/文档/计划/图谱/番茄）全覆盖。' },
];
const idx = ref(0);

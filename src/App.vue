...
import { refreshSchedConfig, setScheduler, repairBrokenDueAt, pruneUserOps } from './repo.js';
...
const navItems = [
  ...
  { path: '/monitor', label: '超级监控', icon: '🧾', i18nKey: 'nav.privacy' },
...
onMounted(() => {
  ...
  // 埋点保留期：清理超过 365 天的 userOps（写墓碑让对端一并清，防中枢副本复活）
  pruneUserOps().catch(() => {});
